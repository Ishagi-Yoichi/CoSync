            ...
            <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
                ...
                >
                    ...
                    <div className="mt-8 grid gap-4">
                        {roomBenefits.map(({ icon: Icon, title, copy }) => (
                            <div key={title} className="rounded-[26px] border border-white/10 bg-white/[0.04] p-4">
                ...
                >
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="hidden rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-slate-100 transition-colors hover:bg-white/10 md:inline-flex"
                        >
                            Generate ID
                        </button>
                    </div>
                    ...
                    <div className="mt-8 space-y-5">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                            ...
                            <button
                                onClick={createNewRoom}
                                className="premium-button premium-button-secondary inline-flex items-center justify-center gap-2 md:hidden"
                            >
