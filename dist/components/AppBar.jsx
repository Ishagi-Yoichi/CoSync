...
export default function AppBar() {
    ...
    return (<div className="bg-black border border-white p-4 flex justify-between items-center mt-4 sm:mt-7 rounded-3xl mx-auto w-full max-w-5xl px-4 sm:px-6">
            ...
            {/* Mobile Menu Button */}
            <button className="md:hidden text-white hover:text-blue-400 transition" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label="Toggle menu">
            ...
            {isMenuOpen && (<div className="absolute top-full left-0 right-0 bg-black border border-white border-t-0 rounded-b-3xl p-4 mt-2 mx-4 md:hidden z-50">
